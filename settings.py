...
# channels that should be considered for the processing
CHANNEL_NAMES = get_env_as_list("CHANNEL_NAMES")
# emojis that should be considered for the processing
EMOJIS = get_env_as_list("EMOJIS", default=["👍", "👎"])
# how to highlight users that voted for the specific emoji, same order as emojis
